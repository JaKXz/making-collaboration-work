...
module.exports = {
  ...
  'NavPanel Test': function(client) {
    ...
    client.click(NAVPANEL_CLOSE_BUTTON)
    client.expect.element(NAVPANEL).to.not.be.visible
  },
  'Page Test': function(client) {},
  'Tags Page Test': function(client) {
    client.url('http://localhost:9000/tags')

    client.expect.element('#main > section > ul > li:nth-child(1) > a').to.be
      .visible
  },
  'Footer Form Test': function(client) {
    client
      ...
      .waitForElementVisible(
        '#footer > section:nth-child(1) > form > ul > li > input[type="submit"]',
        1000
      )
